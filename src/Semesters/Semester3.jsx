...
function Semester3() {
  ...
  const subjects = [
    ...
    {
      id: 5,
      name: "ETC - Effective Technical Communication",
      code: "3130706",
      icon: <FaGlobe />,
      color: "blue",
    ...
    },
    {
      ...
      materials: {
        syllabus:
          "https://drive.google.com/drive/folders/1egznPvI6IgXhR4MG1bTD9EK_ATaqigxB",

        papers:
          "https://drive.google.com/drive/folders/1AjQLrcQLTN2j8elBGUL8oznHK6oT0omv",

        solutions:
          "https://drive.google.com/drive/folders/10AvROr5wvHqi-wcvmLY-Li0g-Id1BqUZ",

        imp: "https://drive.google.com/drive/folders/1uHbgDPowL3Tb68SLFvGa_Eekn_hWr-vK",

        impQna:
          "https://drive.google.com/drive/folders/1RFWMxL6vULpFmvdW7LmOk7slTRz3Z23z",

        ppt: "https://drive.google.com/drive/folders/1ax04dDvxXD2dQSmxBy3eopfeG5xXpxSX",

        book: "https://drive.google.com/drive/folders/1tmxEr2rStSBJ92ZAMMfTAZrCj-1xF5C8",

        notes:
          "https://drive.google.com/drive/folders/1OG-unh3kTSIWzHKfONtDVJSVgmnJFGz1",
